...
//        optionImageView optionTagLable nicknameLabel creationDateLabel commentDivider descriptionUILabel actionButton
    ...
    func getSolutionCellData() -> ReplyCellData? {
...
class SolutionCellHeader: UITableViewHeaderFooterView {
    //MARK: - Properties
    
    static let identifier = "SolutionCellHeader"
    private var solutionId: Int?
